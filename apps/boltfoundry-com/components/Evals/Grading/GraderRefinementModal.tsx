...
export function GraderRefinementModal({
  ...
  const { isRefining, refinementProgress, startRefinement } =
    useRefinementContext();
          ...
          {refinementProgress.map((progress) => (
            ...
            >
              ...
              <BfDsProgressBar
                ...
                size="small"
                state={progress.status === "failed" ? "error" : "default"}
                showValue
