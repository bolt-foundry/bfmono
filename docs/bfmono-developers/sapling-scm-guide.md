...
Sapling is a source control system developed by Meta, designed for large-scale development. It's compatible with Git repositories while offering a more streamlined workflow and better performance at scale.
