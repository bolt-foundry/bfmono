...
continue with mock data approach?** A: Use real GraphQL BfSample backend. Phase
...
create new ones for PromptGrade interface?** A: Reuse existing SampleDisplay.tsx
